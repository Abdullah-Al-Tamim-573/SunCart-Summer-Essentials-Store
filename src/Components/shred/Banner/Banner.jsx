  ...
  return (
    ...
    {/* 1st */}
      <div className="carousel w-full">
        <div id="slide1" className="carousel-item xl:h-[500px] 2xl:h-[800px] relative w-full">
        ...
        {/* 2nd */}
        <div id="slide2" className="carousel-item xl:h-[500px] 2xl:h-[800px] relative w-full">
        ...
        {/* 3rd */}
        <div id="slide3" className="carousel-item  xl:h-[500px] 2xl:h-[800px] relative w-full">
